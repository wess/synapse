...
export const app: Page = {
  ...
  body: `
    ...
    <p>A circle is sized by how much is tied to it and coloured by the project it belongs to. Click one to read that memory beside the map, with its scope, source, and date. A hollow circle is a superseded memory: out of recall, still in the store, still restorable.</p>
