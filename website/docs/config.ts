  ...
  body: `
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td><code>SYNAPSE_PAGE</code></td><td>Chooses which dashboard page opens first: <code>memory</code>, <code>mesh</code>, <code>console</code>, <code>skills</code>, <code>vaults</code>, or <code>settings</code>. Anything else opens Connections.</td><td>Opening the app straight to the screen you want.</td></tr>
