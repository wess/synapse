...
export const tutorials: Page = {
  ...
  body: `
    ...
    <ol class="steps">
      <li><h3><a href="connect/">Install and connect your first tools</a></h3><p>Start from the release archive, install the CLI, connect Codex or Claude Code, and verify all three MCP tools from the app, the terminal, and the tool itself.</p></li>
